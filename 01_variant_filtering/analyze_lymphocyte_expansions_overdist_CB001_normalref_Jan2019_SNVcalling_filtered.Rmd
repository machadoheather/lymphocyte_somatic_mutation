---
title: "stemcellCB2hsc_lymph22_filtered SNV filter final July, 2019"
...
knitr::opts_knit$set(root.dir = '/Users/hm8/sanger/lymphocyteExpansionSequenceAnalysis/stemcellCB2hsc_lymph22_filtered')
library(ggplot2)
library(cowplot)
library(caTools)
library(reshape2)
...
groupname = "stemcellCB2hsc_lymph22"
...
dpkeep = !(sample_names1 %in% "PD42874b_lo0010")
...
```{r}
m3$Cell.type2 = factor(m3$Cell.type2, levels=levels(factor(m3$Cell.type2) ) ) # get rid of unused factor (B mem)
