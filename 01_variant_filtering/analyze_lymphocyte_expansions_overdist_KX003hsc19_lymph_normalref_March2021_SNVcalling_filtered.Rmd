---
title: "KX003hsc19_lymph_filtered SNV filter final March2021"
...
knitr::opts_knit$set(root.dir = '/Users/hm8/sanger/lymphocyteExpansionSequenceAnalysis/KX003hsc19_lymph_filtered')
library(ggplot2)
library(cowplot)
library(caTools)
library(reshape2)
...
groupname = "KX003hsc19_lymph"
system("mkdir -p figures")
groupname = "KX003hsc19_lymph"
shearw = read.table(paste(root, "/lymphocyteWGS/KX003hsc19_lymph_v2/",groupname,".shearwater.vaf40.txt", sep=""), sep="\t", stringsAsFactors = F, header=T)
...
length(unique(shearw$colony))
## 45 colonies


## Original VAFs (mutation ID as rowname)
HQdp1 = read.table(paste(root, "/lymphocyteWGS/KX003hsc19_lymph_v2/", groupname,"_totalDP.txt", sep=""), stringsAsFactors = F, header=T, check.names=F)
HQalt1 = read.table(paste(root, "/lymphocyteWGS/KX003hsc19_lymph_v2/", groupname,"_alternateDP.txt", sep=""), stringsAsFactors = F, header=T, check.names=F)

sample_names1 = colnames(HQdp1)
sum(sample_names1 %in% unique(shearw$colony) )  ## all represented in shearwater: 45
Nsamples = length(sample_names1) 

HQdpNA = HQdp1
HQdpNA[HQdp1==0] = NA
HQfreq1 = HQalt1/HQdpNA

## Don't consider variants identified in a colony we're not analyzing (in the DP data)
...
# removed due to low dp: "PD43974dc" "PD43974dm"
# removed due to polyclonal: none
## NOT keeping "PD43974ay" (will have a total of 9 HSCs, none from the clonal expansion)
hsc_omit = c( "PD43974az", "PD43974k","PD43974bf","PD43974bt","PD43974cp", "PD43974bn", "PD43974cg", "PD43974i","PD43974bj","PD43974p","PD43974ay")
dpkeep = !(sample_names1 %in% hsc_omit) & !(sample_names1 %in% c("PD43974dc", "PD43974dm"))
...
HQdp_keep = subset(HQdp, !(rownames(HQdp) %in% flt_rho_toss) )
```
...
## Use model based off of 19 HSCs (more)
#         b0          b1         lrc 
 # -71.712633 1496.632645   -2.052166 
model.as = c(-71.712633, 1496.632645,   -2.052166)
