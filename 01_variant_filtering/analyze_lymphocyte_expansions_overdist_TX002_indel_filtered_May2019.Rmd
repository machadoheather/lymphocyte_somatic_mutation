---
title: "tonsilPS indel filtering July 2019"
...
knitr::opts_knit$set(root.dir = '/Users/hm8/sanger/lymphocyteExpansionSequenceAnalysis/tonsilPS_filtered')
library(ggplot2)
library(cowplot)
library(caTools)
library(reshape2)
...
model.as = c(-4.576087, 31.674937, -3.280493) # use tonsilMS/tonsilPS combined data for correction
mymodel = function(x){
  b0 = model.as[1]
  b1 = model.as[2]
  lrc = model.as[3]
