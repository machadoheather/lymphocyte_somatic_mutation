...
#bsub -J mutbins -q hugemem -R 'select[mem>=200000] rusage[mem=200000]' -M200000 -e bsub.%J.err -o bsub.%J.out Rscript make_pertype_mut_table_bins.R
#bsub -J mutbins -q hugemem -R 'select[mem>=200000] rusage[mem=200000]' -M200000 -e bsub.%J.err -o bsub.%J.out Rscript make_pertype_mut_table_bins_downsample.R
...
done < my_groups_pcawg_mm.txt

#group=Burkitt_lymphoma
while read group; do
